  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          `relative z-10 flex items-center ${Icon ? "gap-2" : "gap-0"} ${shape.item} px-2 py-2 cursor-pointer outline-none`,
          className
        )}
        {...props}
      >
        {Icon ? (
          <span className="inline-grid">
            ...
            <Icon
              ...
              className={cn(
                "col-start-1 row-start-1 transition-[color,stroke-width] duration-[80ms]",
                isActive || checked
                  ? "text-foreground"
        ...
        <span className="inline-grid min-w-0 flex-1 text-[13px]">
          ...
          <span
            className={cn(
              "col-start-1 row-start-1 transition-[color,font-variation-settings] duration-[80ms]",
              isActive || checked
                ? "text-foreground"
                : "text-muted-foreground"
            )}
